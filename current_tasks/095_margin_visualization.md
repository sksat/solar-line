...
## Scope
1. Add time-series charts showing how margins evolve during the voyage:
   - Thrust profile (推力プロファイル) over time
   - Cumulative radiation dose (合計被曝量) over time
   - Nozzle remaining life vs burn time consumed
