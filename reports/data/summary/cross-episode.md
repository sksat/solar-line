...
EP03（土星→天王星）が最大の面変更を要する理由は、土星からの出発位置が黄道面の上方（+47,708千km）にあり、天王星到着時も上方（+36,496千km）に位置するが、面外距離の差（11,212千km）と遷移距離の組み合わせが大きな面変更ΔVを要求するためである。
...
土星と天王星が共に黄道面上方に位置しており、Z高度の差は約11,212千km。地球は黄道面にほぼ位置している（定義上、黄道はほぼ地球軌道面）。
