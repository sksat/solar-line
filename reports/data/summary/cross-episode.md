...
**インタラクティブ3Dビューア**（[ソースコード](https://github.com/sksat/solar-line/blob/main/ts/examples/orbital-3d.html)）— 全航路・土星リング交差・天王星接近の3Dシーンをマウス操作で回転・ズームして確認できます。全航路シーンではタイムスライダーで約124日間の惑星移動と船の航行をアニメーション再生できます。
