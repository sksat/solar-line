...
2. **EP02トリム推力到達速度**: 数値軌道伝搬によるトリム推力遷移は、土星接近時にv∞≈90 km/sを示し、0.61 km/sの捕捉ΔVと整合しない。弾道モデル（v∞ = 4.69〜9.21 km/s）は物理的に妥当だが、トリム推力モデルとの統合はなお未解決である（→ [第2話分析](../episodes/ep-002.html)を参照）。
