...
```chart:bar
caption: 各話のピーク速度 β (v/c %) — 全話で相対論的補正は0.1%未満
unit: "% of c"
bars:
  - label: EP01（72h）
    value: 1.42
    color: "#3b82f6"
    annotation: "4,249 km/s, 補正0.027%"
  - label: EP02（トリム87d）
    value: 0.02
    color: "#22c55e"
    annotation: "60 km/s, 補正≈0%"
  - label: EP03（143h）
    value: 1.86
    color: "#f97316"
    annotation: "5,583 km/s, 補正0.046%"
  - label: EP04（65%推力）
    value: 0.70
    color: "#eab308"
    annotation: "2,101 km/s, 補正0.007%"
  - label: EP05（帰還）
    value: 2.54
    color: "#ef4444"
    annotation: "7,622 km/s, 最大でも補正0.086%"
```
