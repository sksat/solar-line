...
ケストレル号の公称質量は48,000 tだが、brachistochrone分析から実効質量は約300 tと推定されている（詳細は[船舶分析](ship-kestrel.html)を参照）。本レポートではこの推定値を使用する。
...
- [Part 1 — 火星からガニメデへ](../episodes/ep-001.html) — フリップ機動（300秒、299N）、ペリジュピター通過時の構造限界
- [Part 4 — タイタニアから地球へ](../episodes/ep-004.html) — 非対称推力補正（1,853N）、65%出力制限下の制御
- [Part 5 — 天王星から地球LEOへ](../episodes/ep-005.html) — ノズル劣化によるRCS負荷6,370N、最終LEO投入
- [ケストレル号の分析](ship-kestrel.html) — ノズル損傷の進行と推進系全体への影響
