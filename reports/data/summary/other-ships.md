...
```chart:bar
caption: 公安艦隊の33時間到着に必要な加速度（シナリオ比較）
unit: "g"
logScale: true
bars:
  - label: ケストレル EP03同区間
    value: 3.33
    color: "#58a6ff"
    annotation: "143時間 — 民間貨物船"
  - label: 艦隊シナリオ1（0.67 AU）
    value: 2.9
    color: "#f97316"
    annotation: "33h, 842 km/s — 現実的"
  - label: 艦隊シナリオ2（9.4 AU）
    value: 40
    color: "#ef4444"
    annotation: "33h, 11,784 km/s — 極端"
```
...
```chart:bar
caption: 核魚雷迎撃の物理的不可能性 — 速度差210倍（対数スケール）
unit: "km/s"
logScale: true
bars:
  - label: 核魚雷推定速度
    value: 10
    color: "#ef4444"
    annotation: "化学推進 — 数km/s級"
  - label: ケストレル最終速度
    value: 2100
    color: "#58a6ff"
    annotation: "2,100 km/s (0.7%c) — 殺傷圏通過0.038秒"
  - label: 地球-月の距離/秒
    value: 384
    color: "#8b949e"
    annotation: "参考: 月軌道を0.18秒で横断する速度域"
```
...
- [Part 2 — 木星脱出からエンケラドスへ](../episodes/ep-002.html) — 50万t級大型船の遭遇、恒星掩蔽による検出
- [Part 4 — タイタニアから地球へ](../episodes/ep-004.html) — 公安艦隊の33時間到着、追跡シナリオ
- [Part 5 — 天王星から地球LEOへ](../episodes/ep-005.html) — 核魚雷の迎撃不可能性、最終防衛線
- [インフラストラクチャ分析](infrastructure.html) — ビーコン停波の政治的背景
