...
---
- 分析にあたっては、見落としている視点を nice-friend やこれまでの人間からの指示などから得ること。新たな視点が入った場合は、分析を再度やり直すこと。特にラフな解析でも妥当とは判断が付かなかったものや、疑問点が残った部分について重点的に。その再試から新たな視点や疑問が発生することもあると思う。